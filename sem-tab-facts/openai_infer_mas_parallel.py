...
def gpt(table, notes, statement):
    ...
    answer, collaboration = paneltr_integrated(system_prompt, prompt, silent=True)
    try:
...
def process_item(item):
    ...
    try:
        ...
        print(f"Error processing item with id {item.get('global_id', 'UNKNOWN')}: {e}")
        result = {
...
if __name__ == "__main__":
    ...
    output_jsonl_path = f'/./PanelTR/sem-tab-fact/outputs/MAS_ds_test_0107_15.jsonl'
